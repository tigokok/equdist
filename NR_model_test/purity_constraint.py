...
from NR_model_test.distillation_types import FUG_state, State
from NR_model_test import functions, thermodynamics, NR_model
...
def minimum_reflux(state: FUG_state):
    ...
    theta = jaxopt.Bisection(optimality_fun=underwood, lower=(1.0001), upper=alpha_light_key - 0.001,
